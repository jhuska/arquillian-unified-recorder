...
public class ExporterObserver {
    ...
    public void observeExportReportEvent(@Observes ExportReport event) throws Exception {

        exporter.get().export(event.getReport());

        reportExportedEvent.fire(new ReportExported());
    }
}
