 ...
 */
package org.arquillian.extension.recorder.reporter.configuration;

import java.util.logging.Level;
import java.util.logging.Logger;

import org.arquillian.extension.recorder.RecorderConfigurator;
import org.arquillian.extension.recorder.reporter.event.ReporterExtensionConfigured;
...
public class ReporterConfigurator extends RecorderConfigurator<ReporterConfiguration> {
    ...
    @Inject
    private Event<ReporterExtensionConfigured> reporterExtensionConfigured;
    ...
    public void configureExtension(ArquillianDescriptor descriptor) {
        ...
        reporterExtensionConfigured.fire(new ReporterExtensionConfigured());
    }
}
