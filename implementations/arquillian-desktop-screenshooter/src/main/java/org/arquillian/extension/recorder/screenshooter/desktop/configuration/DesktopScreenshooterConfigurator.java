...
package org.arquillian.extension.recorder.screenshooter.desktop.configuration;
...
public class DesktopScreenshooterConfigurator extends ScreenshooterConfigurator {
    ...
    @Inject
    private Event<ScreenshotExtensionConfigured> screenshooterExtensionConfigured;
    ...
    public void configureExtension(@Observes ArquillianDescriptor descriptor) {
        ...
        screenshooterExtensionConfigured.fire(new ScreenshotExtensionConfigured());
    }
