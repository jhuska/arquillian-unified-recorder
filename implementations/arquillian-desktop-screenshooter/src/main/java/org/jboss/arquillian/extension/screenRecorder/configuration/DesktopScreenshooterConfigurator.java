...
import static org.arquillian.extension.recorder.screenshot.ScreenshooterConfigurator.EXTENSION_NAME;
...
public class DesktopScreenshooterConfigurator extends ScreenshooterConfigurator {
    ...
    public void configureExtension(@Observes ArquillianDescriptor descriptor) {
        ScreenshooterConfiguration conf = new DesktopScreenshooterConfiguration();
    ...
    @Override
    public void validate(ScreenshooterConfiguration configuration) throws RecorderConfigurationException {
        ((DesktopScreenshooterConfiguration) configuration).validate();
    }
